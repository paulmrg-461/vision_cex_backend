"""
Train an Ultralytics YOLO detection model for car parts (bounding boxes).
...
If --device is 'auto', this script selects GPU '0' if available, otherwise 'cpu'.
"""
...
def main():
    ...
    parser.add_argument("--data", type=str, default="/app/backend/datasets/carparts-det/data.yaml")
    ...
    print(f"Entrenando detección: data={args.data}, model={args.model}, epochs={args.epochs}, imgsz={args.imgsz}, device={device_final}")
